...
/// Adjust the Sun's velocty to offset the system momentum.
...
fn output_energy(bodies: &mut [Body; BODIES_COUNT]) {
    ...
    for (i, body) in bodies.iter().enumerate() {
        ...
        // Add the potential energy between
        // this body and every other body.
...
fn advance(bodies: &mut [Body; BODIES_COUNT]) {
    // Compute the pt-to-pt vectors between each pair of bodies
